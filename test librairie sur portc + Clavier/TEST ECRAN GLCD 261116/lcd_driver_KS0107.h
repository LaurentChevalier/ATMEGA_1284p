...
#define LCD_CS1  (1<<PIN5) // Chip select 1
#define LCD_CS2  (1<<PIN6) // Chip select 2
//#define LCD_RST  (1<<PIN7) // RESET bit - IF 0 IT STARTS INITIALIZATION
#define LCD_RS   (1<<PIN2) //MCU pin to LCD RS  0 == command  | 1 == DDRAM data 
#define LCD_RW   (1<<PIN3) //MCU pin to LCD R/W 0 == write to 0|1 == read from  
#define LCD_E    (1<<PIN4) //MCU pin to LCD E   1 == Enable operation - execute
